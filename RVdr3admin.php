...
if (isset($_POST["submit"])) {
   ...
   $sql="INSERT INTO patient_dr3 (`ID`, `first_name`, `last_name`, `gender`, `contact`, `date`, `time`, `groupBlood`)
    VALUES (NULL,'$first_name','$last_name','$gender','$numero_tel','$date','$time','$groupBlood')";
   $result = mysqli_query($conn, $sql);
   if ($result) {
    header("Location: dr3admin.php?msg=New record created successfully");
 } else {
