        ...
        <section class="main">
          ...
          <div class="card--container">
            <div class="center">
             ...
             <button class="btnadd"><a href="rendez-vousdr2.php" class="btnadd">Add appointment +</a></button>
            ...
            <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="icons">
                      <a href="editdr2.php?id=<?php echo $row['ID'] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>

                        <a href="deletedr2.php?id=<?php echo $row['ID'] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5 "></i></a>
                    </td>
                  </tr>
                  <?php
                     }
