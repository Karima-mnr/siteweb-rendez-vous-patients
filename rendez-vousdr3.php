...
if (isset($_POST["submit"])) {
   ...
   if ($result) {
    header("Location: dr3user.php?msg=New record created successfully");
 } else {
       ...
       <div class="container">
            <div class="formulaire">
                ...
                <form action="#" method="post">
                        ...
                        <button class="submit-btnn" name="submit" ><a class="submit-btnn" href="dr3user.php">Cancel</a></button>
                         </div>      
