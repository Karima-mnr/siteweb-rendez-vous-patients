    ...
    <div class="card-container">
        <div class="card">
            ...
            <div class="card-content">
               ...
               <button> <a href="dr1admin.php" class="card-button">Click Here</a></button>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-content">
               ...
               <button><a href="dr2admin.php" class="card-button">Click Here</a></button>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-content">
               ...
               <button> <a href="dr3admin.php" class="card-button">Click Here</a></button>
            </div>
        </div>
    </div>
