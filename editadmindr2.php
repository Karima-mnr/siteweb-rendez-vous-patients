...
if (isset($_POST["submit"])) {
   ...
   $sql=" UPDATE `patient_dr2` SET `first_name`='$first_name',`last_name`='$last_name',`gender`='$gender',`contact`='$numero_tel',`date`='$date',`time`='$time',`groupBlood`='$groupBlood' WHERE ID=$id";
   $result = mysqli_query($conn, $sql);
   if ($result) {
    header("Location: dr2admin.php?msg=Date update successfully");
 } else {
       ...
       <div class="container">
            <div class="formulaire">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM `patient_dr2` WHERE ID = $id LIMIT 1 ";
                    $result = mysqli_query($conn, $sql);
                ...
                <form action="#" method="post">
                        ...
                        <div class="form-group">
                         ...
                         <div class="btnn">      
                            ...
                            <button class="submit-btnn" name="submit"><a class="submit-btnn" href="dr2admin.php">Cancel</a></button>
                         </div>
                </form>
            </div>
